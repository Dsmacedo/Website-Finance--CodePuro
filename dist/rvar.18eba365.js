...
let tempoTotalSegundos = 1046; // 17 minutos e 26 segundos
const atualizaTempo = ()=>{
    ...
    if (tempoTotalSegundos > 0) tempoTotalSegundos--;
    else // Quando o cronômetro chegar a 0, reinicie o tempo para 17 minutos e 26 segundos
    tempoTotalSegundos = 1046;
};
// Atualize o tempo a cada segundo
setInterval(atualizaTempo, 1000);

//# sourceMappingURL=rvar.18eba365.js.map
